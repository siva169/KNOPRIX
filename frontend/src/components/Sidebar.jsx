    ...
    return (
      <div>
        ...
        >
          ...
          {expanded ? <FolderOpen className="w-3.5 h-3.5 text-accent" /> : <Folder className="w-3.5 h-3.5 text-amber-400" />}
          {title}
        </button>
    ...
    <>
              ...
              return (
                ...
                >
                  <span className="flex items-center gap-2 truncate">
                    {active ? <FolderOpen className="w-4 h-4 text-secondary" /> : <Folder className="w-4 h-4 text-amber-400" />}
      ...
      <div className="p-3 md:p-4 border-t border-glass-borderDark space-y-1.5">
        <button onClick={onBookmarks} className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-medium text-ivory/70 hover:bg-white/5 hover:text-ivory transition">
          <Bookmark className="w-4 h-4 text-amber-400" /> Bookmarks Drawer
        </button>
